...
object GameResources {
	...
	class CheckerShader(shaderData: ShaderData) : Shader(shaderData) {
		fun matrices(projectionView: Matrix4f, model: Matrix4f): CheckerShader {
			uniformPVM(0, projectionView, model)
			return this
		}
